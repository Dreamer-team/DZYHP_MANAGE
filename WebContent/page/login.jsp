...
<table width="100%" height="594" border="0" align="center" cellpadding="0" cellspacing="0"  style="margin:0px; padding:0px">
  <tr>
    <td height="594"  align="center" valign="top" background="${ctx}/page/Images/bj.gif">
	<table width="465" height="414" border="0" align="center" cellpadding="0" cellspacing="0" >
      <tr>
        <td  height="152" colspan="3" valign="bottom"><img src="${ctx}/page/Picture/logo.png" width="460" height="230" /></td>
      </tr>
      <tr>
        <td width="15" height="262" background="${ctx}/page/Images/bj1.gif">&nbsp;</td>
        <td width="420" valign="middle" background="${ctx}/page/Images/bj2.gif">
		<form id="form1" name="form1" method="post" action="${ctx}/login.do" onsubmit="return check();">
		<table width="100%" height="170" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td align="left"><img src="${ctx}/page/Picture/checkcode.php"  onclick="this.src='/inc/checkcode.php';" style="cursor:pointer;" /></td>
              <td align="left"> </td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              ...
              <td width="20%" align="right" valign="right"><a href="back.html"><span class="STYLE4">找回密码</span></a></td>
                  <br />

              <td width="34%" height="55" align="left"> 
			  <input name="image" type="image"  style="width:60px; height:55px;" src="${ctx}/page/Images/login2.gif" />			  </td>
            </tr>
        </table>
		 </form>		</td>
        <td width="13" background="${ctx}/page/Images/bj3.gif">&nbsp;</td>
      </tr>
    </table>
	...
	<table width="100%" height="64" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="64" align="center" valign="middle"><span class="STYLE6">版权所有：平顶山学院实验室与设备管理处 <br />
              <br />
              河南省平顶山市新华区平顶山学院  邮编:467001</span></td>
      </tr>
    </table></td>
  </tr>
</table>
